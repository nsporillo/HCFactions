...
public enum TL {
    ...
    COMMAND_CLAIM_FINISHED("<i>Finished radius claim."),
    ...
    COMMAND_KICK_COOLING("<b>That player is cooling down from combat!"),
    ...
    COMMAND_STUCK_NOTELEPORT("<a>Could not find a safe location to teleport to!"),
